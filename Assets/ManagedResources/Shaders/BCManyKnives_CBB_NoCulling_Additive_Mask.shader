...
Shader "CasualGame/BcManyknives/CBB_NoCulling/Additive_Mask" {
    Properties {
        ...
        [HideInInspector][Enum(UnityEngine.Rendering.StencilOp)]_StencilOpFail ("Stencil Fail Operation", Float) = 0
        [HideInInspector][Enum(UnityEngine.Rendering.StencilOp)]_StencilOpZFail ("Stencil Z-Fail Operation", Float) = 0
    }
    SubShader {
        Tags {
